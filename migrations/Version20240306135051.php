 ...
 */
final class Version20240306135051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE playlist DROP nb_formations');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE playlist ADD nb_formations INT DEFAULT NULL');
    }
}
